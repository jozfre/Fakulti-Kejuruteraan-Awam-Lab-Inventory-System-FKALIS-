...
<head>
  ...
  <title>View Instrument | Lab Assist</title>
            ...
            <div class="card card-primary">
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="laboratory">Instrument Name</label>
                    <input name="instrumentname" class="form-control" id="instrumentname" value="<?= $instrument['instrumentname'];?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="laboratory">Laboratory</label>
                    <input name="lab" class="form-control" id="lab" value="<?= $instrument['laboratorytitle'];?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="status">Instrument Status</label>
