...
<head>
  ...
  <title>List of User | Moderator</title>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <div class="col-sm-6">
                  <button type="button" class="btn btnn-block btn-primary btn-sm float-right" onclick="location.href='addNewUser.php'">Add New Lab Assistant</button>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
