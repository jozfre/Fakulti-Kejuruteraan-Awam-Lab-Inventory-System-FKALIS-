...
<head>
  ...
  <title>View User | Moderator</title>
                  ...
                  <div class="card-body">
                    ...
                    ?>
                      ...
                      <label for="status">Laboratory Incharged Name</label>
                        ...
                        ?>
                      <div class="form-group">
                        <input name="laboratoryname" class="form-control" id="labname" value="<?= $data['laboratorytitle']; ?>" readonly>
                      </div>
                    <?php
