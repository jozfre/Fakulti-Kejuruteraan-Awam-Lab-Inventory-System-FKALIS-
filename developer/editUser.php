...
if(isset($_POST['save'])){
  ...
  if($result || $result2){
    ...
    $_SESSION['message'] = "User Failed to Edit";
    header('location:User.php');
    exit(0);
  }
}
...
<head>
  ...
  <title>Edit User | Developer</title>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              if(isset($_GET['token']))
              {
                $userid = mysqli_real_escape_string($conn, $_GET['token']);
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input name="userid" type="id" class="form-control" id="inputID"  value="<?= $user['USER_ID'];?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="inputName">Name</label>
                    <input name="name" type="name" class="form-control" id="inputName" value="<?= $user['USER_NAME'];?>" readonly>
                  </div>
                  <div class="form-group">
